...
with gr.Blocks(
        ...
        with gr.Column(scale=7, min_width=560):
            gr.Markdown(
                ...
                <div class="section-card">
                    <h3 style="margin-top:0;">1. Envie seu documento</h3>
                    <p class="helper-text">
                        Escolha um arquivo.
                    </p>
                </div>
            ...
            file_input = gr.File(
                label="📄 Arquivo",
                file_types=[".pdf", ".docx", ".txt", ".md", ".html", ".htm", ".tex"],
                type="filepath",
            )
            ...
            gr.Markdown(
                ...
                <div class="section-card" style="margin-top:12px;">
                    ...
                    <p class="helper-text">Faça uma prévia antes de gerar o áudio completo.</p>
                </div>
                """
            )
    ...
    gr.Markdown(
        ...
        <div class="footer-note">
            Execução local • Interface dark • IA local • Leitura científica com áudio
        </div>
        """
    )
